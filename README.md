...
​대다수 깃헙 PS 뱃지들은 문제를 얼마나 풀었는가에 초점을 맞추지, PS 생태계에 얼마나 기여했는지정리해서 보여주는 뱃지를 본 기억은 없기 때문입니다.

그래서 나름대로 고민을 하다가, 백준 온라인 저지 문제에 기여(문제 출제, 문제 검수 등) 한 정도를 나타내는 뱃지를 만들면 되겠다는 생각을 하였습니다.
